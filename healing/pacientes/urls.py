...
from pacientes.views import (
    ...
    ExcluirPacienteView, DetalharPacienteView, AnonimizarPacienteView,
...
urlpatterns = [
    ...
    path('pacientes/<int:pk>/anonimizar/', AnonimizarPacienteView.as_view(), name='anonimizar_paciente'),
