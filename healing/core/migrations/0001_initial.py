    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.CharField(choices=[('admin', 'Administrador'), ('medico', 'Médico'), ('recepcionista', 'Recepcionista')], default='recepcionista', max_length=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operacao', models.CharField(choices=[('INSERT', 'Inserção'), ('UPDATE', 'Atualização'), ('DELETE', 'Exclusão')], max_length=10)),
